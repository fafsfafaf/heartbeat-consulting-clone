...
export const Header: React.FC<HeaderProps> = ({ onOpenModal, onNavigate }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-colors duration-200 ${isScrolled ? 'bg-[#141414] border-b border-white/5 shadow-md' : 'bg-transparent py-6'}`}>

        ...
        <div className="bg-[#141414] min-h-screen text-white pt-32 pb-20 px-4 md:px-8">
            <div className="container mx-auto max-w-4xl">
                ...
                <div className="space-y-8 text-gray-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">DOES HEARTBYTEAI SHARE PERSONAL INFORMATION WITH OTHERS?</h2>
                        <p className="mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">HOW IS PERSONAL INFORMATION USED FOR COMMUNICATIONS?</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">HOW IS PERSONAL INFORMATION SECURED?</h2>
                        <p>
                    ...
                    <section>
                        ...
                        <p>
                            This site contains links to other sites that provide information that we consider to be interesting. HeartbyteAI is not responsible for the privacy practices or the content of such web sites.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">PUBLIC DISCUSSIONS</h2>
                        <p>
                            This site may provide public discussions on various business valuation topics. Please note that any information you post in these discussions will become public, so please do not post sensitive information in the public discussions. Whenever you publicly disclose information online, that information could be collected and used by others. We are not responsible for any action or policies of any third parties who collect information that users disclose in any such forums on the web site. HeartbyteAI does not agree or disagree with anything posted on the discussion board. Also remember that you must comply with our other published policies regarding postings on our public forums.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">HOW CAN A USER ACCESS, CHANGE, AND/OR DELETE PERSONAL INFORMATION?</h2>
                        <p>
                            You may access, correct, update, and/or delete any personally-identifiable information that you submit to the web site. You may also unsubscribe from mailing lists or any registrations on the web site. To do so, please either follow instructions on the page of the web site on which you have provided such information or subscribed or registered or contact us at info@heartbyteai.com
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            HeartbyteAI will not intentionally collect any personal information (such as a child's name or email address) from children under the age of 13. If you think that we have collected personal information from a child under the age of 13, please contact us.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            HeartbyteAI reserves the right to modify this statement at any time. Any changes to this Privacy Policy will be listed in this section, and if such changes are material, a notice will be included on the homepage of the web site for a period of time. If you have any questions about privacy at any websites operated by HeartbyteAI or about our website practices, please contact us at: info@heartbyteai.com
                        </p>
                    </section>
                </div>
            </div>

...
export const WhoWeServe: React.FC<WhoWeServeProps> = ({ onOpenModal }) => {
  ...
  const segments = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?q=80&w=2940&auto=format&fit=crop"
    },
    {
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?q=80&w=2982&auto=format&fit=crop"
    }
  ];

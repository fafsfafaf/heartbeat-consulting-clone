        ...
        <div className="bg-white min-h-screen pt-32 pb-20">
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="space-y-8 text-center animate-in slide-in-from-bottom-8 fade-in duration-500">
                    ...
                    {/* Headline */}
                    <div>
                        <h2 className="text-3xl md:text-5xl font-black text-black leading-tight mb-4 uppercase tracking-tight">
                    ...
                    {/* Q&A Videos */}
                    <div>
                        <h3 className="text-xl md:text-3xl font-bold text-black mb-8 uppercase tracking-tight">
